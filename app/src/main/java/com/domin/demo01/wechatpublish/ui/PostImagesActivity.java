...
import com.domin.demo01.MyApplication;
import com.domin.demo01.R;
import com.domin.demo01.utils.AppUtils;
import com.domin.demo01.utils.DensityUtils;
import com.domin.demo01.utils.ImageUtils;
import com.domin.demo01.utils.InitCacheFileUtils;
import com.domin.demo01.wechatpublish.MyCallBack;
import com.domin.demo01.wechatpublish.OnRecyclerItemClickListener;
import com.domin.demo01.wechatpublish.adapter.PostArticleImgAdapter;
...
public class PostImagesActivity extends AppCompatActivity {
    ...
    public static final String FILE_DIR_NAME = "erhii";//应用缓存地址
    ...
    private void initToolBar() {
        mToolbar.setTitle("发表信息");
        setSupportActionBar(mToolbar);//放到toolbar最后 toolbar的设置才会生效
        ...
        rcvImg.addOnItemTouchListener(new OnRecyclerItemClickListener(rcvImg) {
            ...
            public void onItemClick(RecyclerView.ViewHolder vh) {
                if (originImages.get(vh.getAdapterPosition()).contains(getString(R.string.glide_plus_icon_string))) {//打开相册
                    MultiImageSelector.create().showCamera(true).count(IMAGE_SIZE - originImages.size() + 1).multi().start(PostImagesActivity.this, REQUEST_IMAGE);
                } else {
    ...
    static class MyRunnable implements Runnable {
        ...
        public void run() {
            ...
            for (int i = 0; i < images.size(); i++) {
                ...
                //压缩
                newBitmap = ImageUtils.compressScaleByWH(images.get(i), DensityUtils.dp2px(MyApplication.getInstance().getContext(), 100), DensityUtils.dp2px(MyApplication.getInstance().getContext(), 100));
                //文件地址
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_postimagesactivity, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            case R.id.post_send:
                com.domin.demo01.utils.ToastUtils.showShortToast("发表成功");
                break;
